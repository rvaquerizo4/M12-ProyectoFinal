...
public class HorasControllers {
	...
	//Metodo para eliminar por Id
	 ...
	 //Metodo para actualizar con el PUT
	  @PutMapping("horas/edit/{id}")
	  public hEntradahSalida editarHoras(@RequestBody hEntradahSalida editar, @PathVariable long id) {
		  if (horaRep.existsById(id)) {
			  editar.setId(id);
			  return horaRep.save(editar);
		  }else {
			  return null;
		  }
	  }
